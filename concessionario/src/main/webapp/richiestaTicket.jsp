...
<fieldset class="field">
	<legend> Compila i seguenti campi</legend>
		...
		<label> Titolo </label> <input type="text" name="titolo" id="tipo" placeholder="Inserisci qui l'oggetto della tua richiesta per l'assistenza">
		<label> Messaggio </label> <input type="text" name="messaggio"id="messaggio" placeholder="Inserisci qui la tua richiesta per l'assistenza"> 
